...
\dedication{
	{
		\Huge
		Nochmal der Titel hier\\
	}
	\vspace{0.75cm}
	{
		\Large
		Und hier dann ein etwas längerer\\
		Untertitel der auch über mehrere\\
		Zeilen gehen darf\\
	}
	\vspace{1.5cm}
	{
	...
	{
		\footnotesize
		Text- und Notensatz mit \LaTeX, LilyPond und git.\\
...
\begin{document}
	...
	\include{chapters/gemeinsames_musizieren/gemeinsames_musizieren}
	\include{chapters/der_gaengige_weg/der_gaengige_weg}
