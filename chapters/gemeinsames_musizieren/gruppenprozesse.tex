...
freien Lauf. Durch die Kommunikation mit Mitspielern hingegen, bringen die
...
als ein Ensemble betrachten, das aus \anquote{divergenten Teilpersönlichkeiten
...
%  Konzertsituation das Publikum auch noch anwesend, was wiederum die
%  monologische 
...
unterrichten?). %::: 
schreibt, dass "(...) das Zusammenspiel für Instrumentalschüler eine der
stärksten Quellen der Motivation." ist.  %S. 92 
Das liegt wohlmöglich daran, dass sich der Instrumentalschüler im Vergleich zu
...
könnten. "Wenn jeder an anderen Stellen Schwierigkeiten hat, ist ein Anderer
...
und gelangt dadurch wieder zu mehr Selbstbewusstsein. Aber auch fortgeschrittene
...
sie die eigene Vorstellung oftmals selbst noch einmal mehr schärfen. "In guten
...
stärkt undd hält die Einzelnen." \autocite[94]{mitzscherlich:musikpsychologie}
...
So kann zum Beispiel mit Blick zur Wand geschrieben, mit Bilck zum Fenster
...
Eigeninitiative der Lernenden zu stärke, was auch durch eine aktive
